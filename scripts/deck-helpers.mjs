export const CATEGORY_META = {
  ...
  death_note_characters: {
    label: "Death Note character",
    shortLabel: "Death Note",
    emoji: "📓",
    gradient: ["#0f172a", "#dc2626"],
    tagType: "character",
    hintSeeds: ["From Death Note", "Fictional anime character", "Not a real person"],
    factLead: (name) => `${name} is a character from Death Note.`,
  },
  studio_ghibli_characters: {
    label: "Studio Ghibli character",
    shortLabel: "Ghibli",
    emoji: "🌿",
    gradient: ["#059669", "#0284c7"],
    tagType: "character",
    hintSeeds: ["From Studio Ghibli", "Fictional anime character", "Not a real person"],
    factLead: (name) => `${name} is a character from a Studio Ghibli film.`,
  },
  chainsaw_man_characters: {
    label: "Chainsaw Man character",
    shortLabel: "Chainsaw Man",
    emoji: "🪚",
    gradient: ["#991b1b", "#ea580c"],
    tagType: "character",
    hintSeeds: ["From Chainsaw Man", "Fictional anime character", "Not a real person"],
    factLead: (name) => `${name} is a character from Chainsaw Man.`,
  },
  spy_x_family_characters: {
    label: "Spy x Family character",
    shortLabel: "Spy x Family",
    emoji: "🕵️",
    gradient: ["#1e3a8a", "#be185d"],
    tagType: "character",
    hintSeeds: ["From Spy x Family", "Fictional anime character", "Not a real person"],
    factLead: (name) => `${name} is a character from Spy x Family.`,
  },
  jojo_characters: {
    label: "JoJo character",
    shortLabel: "JoJo",
    emoji: "⭐",
    gradient: ["#7c3aed", "#eab308"],
    tagType: "character",
    hintSeeds: ["From JoJo's Bizarre Adventure", "Fictional anime character", "Not a real person"],
    factLead: (name) => `${name} is a character from JoJo's Bizarre Adventure.`,
  },
  doraemon_characters: {
    label: "Doraemon character",
    shortLabel: "Doraemon",
    emoji: "🔔",
    gradient: ["#0284c7", "#2563eb"],
    tagType: "character",
    hintSeeds: ["From Doraemon", "Fictional anime character", "Not a real person"],
    factLead: (name) => `${name} is a character from Doraemon.`,
  },
  hunter_x_hunter_characters: {
    label: "Hunter x Hunter character",
    shortLabel: "HxH",
    emoji: "🎯",
    gradient: ["#16a34a", "#2563eb"],
    tagType: "character",
    hintSeeds: ["From Hunter x Hunter", "Fictional anime character", "Not a real person"],
    factLead: (name) => `${name} is a character from Hunter x Hunter.`,
  },
  bleach_characters: {
    label: "Bleach character",
    shortLabel: "Bleach",
    emoji: "⚔️",
    gradient: ["#1e293b", "#f97316"],
    tagType: "character",
    hintSeeds: ["From Bleach", "Fictional anime character", "Not a real person"],
    factLead: (name) => `${name} is a character from Bleach.`,
  },
  movie_characters: {
